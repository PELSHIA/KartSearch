...
interface MatchService {
    ...
    suspend fun specificSingleMatchInquiry(@Path("match_id") match_id: String): Response<DetailSingleEntity>

    @GET("/kart/v1.0/matches/{match_id}")
    suspend fun specificTeamMatchInquiry(@Path("match_id") match_id: String): Response<DetailTeamEntity>
